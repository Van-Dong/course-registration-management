...
public class EnrollmentController {
    ...
    ApiResponse<Void> deleteEnrollment(@RequestBody UnenrollCourseRequest request) {
        ...
        return ApiResponse.<Void>builder().message("Unenrollment successfully!").build();
    }
    ...
    String getCourseManager(
        ...
        StudentInCourseResponse studentInCourseResponse =
                enrollmentService.getStudentInCourseById(courseId, page, size);
