...
public class ReportService {
    ...
    public PageResponse<CountEnrollmentInWeekResponse> countEnrollmentInWeek(int weekAgo, int page, int size) {
        ...
        Page<CountEnrollmentInWeekResponse> result = courseRepository.countEnrollmentInWeek(startDateTime,
                endDateTime, PageRequest.of(page - 1, size));
    ...
    public List<String> getWeeks() {
        LocalDateTime oldestDatetime = enrollmentRepository.getOldestEnrollmentDate().orElse(LocalDateTime.now());
